          ...
          <div className="container">
            ...
            <div className="footer-links-wrapper row">
              <div className="links-wrapper-1 col-sm-12 col-md">
                ...
                <ul>
                  <Footerprops name="mac" link="/mac" />
                  <Footerprops name="iPad" link="/iPhone" />
                  <Footerprops name="iPhone" link="/iPad" />
                  <Footerprops name="watch" link="/watch" />
                  <Footerprops name="tv" link="/tv" />
                  <Footerprops name="music" link="/music" />
                  <Footerprops name="Airpods" link="/support" />
                  <Footerprops name="Homepod" link="/support" />
                  <Footerprops name="iPod touch" link="/support" />
                  <Footerprops name="Accesserories" link="/support" />
                  <Footerprops name="Gift Cards" link="/support" />
                </ul>
              </div>
            ...
            <div className="my-apple-wrapper">
              More ways to shop: <a href="link">Find an Apple Store</a> or{" "}
              <a href="link">other retailer</a> near you. Or call
              1-800-MY-APPLE.
            </div>
            <div className="copyright-wrapper row">
              ...
              <div className="footer-links-terms  col-sm-12 order-3 col-lg-6 order-lg-2">
                <ul>
                  ...
                  <li>
                    <a href="link">Sales and Refunds</a>
                  </li>
                  <li>
                    <a href="link">Legal</a>
                  </li>
